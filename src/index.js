...
import SpotifyRoute from './app/route/SpotifyRoute';
import rawRoute from './app/route/rawRoute';
...
app.use('/metal_random_manager/api/Spotify', SpotifyRoute);
app.use('/metal_random_manager/api/raw', rawRoute);
